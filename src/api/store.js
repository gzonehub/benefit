...
export function getCategory() {
  return request.get('/store_api/category', {}, {login: false});
  // return request.get('/store_api/get_pid_cate.html', {}, { login: false });
}
...
export function getProductDetail(id) {
  return request.get('/store_api/details', {id}, {login: false});
}
...
export function getReplyList(id, q) {
  return request.get('/activity_api/reply_list/' + id, q, {login: false});
}
